...
- Imported product families: 13
- Imported products: 13
- Imported specs: 47
- Imported assets: 9
- Datasheet coverage: 9 / 13
- Product URL coverage: 13 / 13
- Missing voltage count: 13
- Missing power count: 13
- Missing color count: 0
- Missing category count: 0
- Unmapped field occurrences: 32
- Unique unmapped field names: 4 (Intensity, Lead Time, Light Conditioning, Sizes)
- Duplicate model count: 0
- Suspicious value count: 0
